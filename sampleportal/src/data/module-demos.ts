...
export const demoModuleConfigs: Record<DemoModuleKey, DemoModuleConfig> = {
  ...
  "tax-insurance": {
    ...
    description: "Track tax due dates, policy renewals, and payment status by property.",
    storageKey: "sampleportal.tax-insurance",
    statusOptions: ["ON_TRACK", "UPCOMING", "OVERDUE"],
    metricLabel: "Upcoming Obligations",
    fields: [
      { key: "property", label: "Property", type: "text", required: true, placeholder: "1124 Preston Rd, Dallas" },
      { key: "taxDue", label: "Tax Due Date", type: "date" },
      { key: "taxAmount", label: "Tax Amount", type: "number", defaultValue: 8450 },
      { key: "renewal", label: "Policy Renewal", type: "date" },
      { key: "premium", label: "Annual Premium", type: "number", defaultValue: 5200 },
      { key: "status", label: "Status", type: "select", options: ["ON_TRACK", "UPCOMING", "OVERDUE"], defaultValue: "UPCOMING" },
    ],
    columns: [
      { key: "property", label: "Property" },
      { key: "taxDue", label: "Tax Due", format: "date" },
      { key: "taxAmount", label: "Tax Amount", format: "money" },
      { key: "renewal", label: "Policy Renewal", format: "date" },
      { key: "premium", label: "Premium", format: "money" },
      { key: "status", label: "Status", format: "status" },
    ],
    seedRows: [
      { id: "ti1", property: "2208 Royal Ln", taxDue: "2026-03-01", taxAmount: 7420, renewal: "2026-03-15", premium: 4610, status: "UPCOMING", updatedAt: "2026-02-19" },
      { id: "ti2", property: "5412 Boulder St", taxDue: "2026-02-10", taxAmount: 6050, renewal: "2026-06-01", premium: 4300, status: "OVERDUE", updatedAt: "2026-02-19" },
    ],
  },
  "note-tracker": {
    title: "Note Tracker",
