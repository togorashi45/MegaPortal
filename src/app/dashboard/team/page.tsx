...
const agentRoster = {
  macmini: [
    { name: "Rusticus", role: "CEO / Chief of Staff", model: "Claude Sonnet 3.5" },
  ],
  vps: [
    { name: "Marcus", role: "Executive Assistant", model: "Claude Sonnet 3.5" },
    { name: "Scipio", role: "Strategy", model: "Claude Sonnet 3.5" },
    { name: "Cato", role: "Operations", model: "Claude Sonnet 3.5" },
    { name: "Crassus", role: "Finance", model: "Claude Sonnet 3.5" },
    { name: "Cicero", role: "Sales/Marketing", model: "Claude Sonnet 3.5" },
    { name: "Ovid", role: "Marketing", model: "Claude Sonnet 3.5" },
    { name: "Euclid", role: "Technical", model: "Claude Sonnet 3.5" },
    { name: "Seneca", role: "Chief of Staff", model: "Claude Sonnet 3.5" },
    { name: "Socrates", role: "Coach", model: "Claude Sonnet 3.5" },
  ],
};
